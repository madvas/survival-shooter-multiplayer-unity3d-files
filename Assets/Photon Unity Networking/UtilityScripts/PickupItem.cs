...
namespace PhotonPickup
{
	...
	public class PickupItem : Photon.MonoBehaviour, IPunObservable
	{
		...
		internal void PunRespawn ()
		{
			...
			if (timeDiffToRespawnTime > 0.1f)
				Debug.LogWarning ("Spawn time is wrong by: " + timeDiffToRespawnTime + " (this is not an error. you just need to be aware of this.)");
			#endif
